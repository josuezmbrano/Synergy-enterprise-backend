import { SetLowPriorityOutput } from 'application/dtos/task/priority-dtos/set-low-priority.dto.js';
import { SetLowPriorityInput } from '@project/common/schemas/task.schema.js'
...
export class SetLowPriorityCase implements BaseUseCase<SetLowPriorityInput, SetLowPriorityOutput> {
    ...
    async execute(input: SetLowPriorityInput): Promise<SetLowPriorityOutput> {
    ...
    private mapToOutput(task: TaskEntityClass, projectPublicId: ProjectIdVo, creatorPublicId: MemberIdVo, assignedToPublicId: MemberIdVo | undefined): SetLowPriorityOutput {
