import { SetHighPriorityOutput } from 'application/dtos/task/priority-dtos/set-high-priority.dto.js'
...
export class SetHighPriorityCase implements BaseUseCase<SetHighPriorityInput, SetHighPriorityOutput> {
    ...
    async execute(input: SetHighPriorityInput): Promise<SetHighPriorityOutput> {
    ...
    private mapToOutput(task: TaskEntityClass, projectPublicId: ProjectIdVo, creatorPublicId: MemberIdVo, assignedToPublicId: MemberIdVo | undefined): SetHighPriorityOutput {
