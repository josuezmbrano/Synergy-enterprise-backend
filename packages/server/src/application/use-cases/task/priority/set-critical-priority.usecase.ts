import { SetCriticalPriorityOutput } from 'application/dtos/task/priority-dtos/set-critical-priority.dto.js'
...
export class SetCriticalPriorityCase implements BaseUseCase<SetCriticalPriorityInput, SetCriticalPriorityOutput> {
    ...
    async execute(input: SetCriticalPriorityInput): Promise<SetCriticalPriorityOutput> {
    ...
    private mapToOutput(task: TaskEntityClass, projectPublicId: ProjectIdVo, creatorPublicId: MemberIdVo, assignedToPublicId: MemberIdVo | undefined): SetCriticalPriorityOutput {
