import { SetCompletedStatusOutput } from 'application/dtos/task/status-dtos/set-completed-status.dto.js';
...
export class SetCompletedStatusCase implements BaseUseCase<SetCompletedStatusInput, SetCompletedStatusOutput> {
    ...
    async execute(input: SetCompletedStatusInput): Promise<SetCompletedStatusOutput> {
        ...
        task.moveToCompleted(targetMemberAssigned.id)
    ...
    private mapToOutput(task: TaskEntityClass, projectPublicId: ProjectIdVo, creatorPublicId: MemberIdVo, assignedToPublicId: MemberIdVo | undefined): SetCompletedStatusOutput {
