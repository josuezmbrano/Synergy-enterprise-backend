...
describe('SetLowPriorityCase - Integration Tests', () => {
    ...
    describe('Guards & Authorization Constraints', () => {
        ...
        it('should throw an error if the actor is a contributor but NEITHER the creator of the task NOR the project owner', async () => {
    ...
    describe('Set Low Priority - Happy Path', () => {

        it('should successfully update task priority to LOW and persist changes even if assignedTo is null', async () => {
